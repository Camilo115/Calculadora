...
@app.route('/')
def index():
	return '<h1>Bienvenido a la calculadora</h1><br><br> <p>Realiza un calculo simple utilizando la página https://apptic2.azurewebsites.net/{operación}/{número 1}/{número 2}</p>'
